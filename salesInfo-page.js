...
$(document).ready(function(){
    ...
    var dText = { avdscale2: '<div class="result-desc">Stamp Duty</div><div class="result-desc2 small">(Pt 2 of AVD Scale 1)</div>', avdscale1: '<div class="result-desc">Stamp Duty</div><div class="result-desc2 small">(Pt 1 of AVD Scale 1)</div>', ssd: '<div class="result-desc">Buyer\'s Stamp Duty</div><div class="result-desc2">(BSD)',Copr:'194 169 032 050 048 049 054 032 072 111 109 101 032 078 101 116 032 080 114 111 112 101 114 116 121 032 083 101 114 118 105 099 101 115 032 076 116 100 046 032 104 116 116 112 058 047 047 119 119 119 046 104 111 109 101 110 101 116 046 099 111 109 046 104 107 047', bsd: '<div class="result-desc">Special Stamp Duty</div><div class="result-desc2">(SSD)</div>' };
        var options={
            dutyText:dText,
            price:'#price',
            duty:'#stamp_duty',
