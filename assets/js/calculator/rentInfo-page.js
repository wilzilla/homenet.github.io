...
$(document).ready(function(){
	...
	var dText={averageRent: '<div class="result-desc">Avg. annual rent**</div>', stampDuty:'<div class="result-desc">= Total stamp duty<br> (Add $5 for a Duplicate)</div>',extraFee:'<div class="result-desc">(extra fee for a copy)</div>', payable: '', atRate: '<div class="result-desc">at rate</div>'};
	var options={
		tableText:tText,
		dutyText:dText,
		rent:'#rent',
