...
$(document).ready(function(){
	...
	var tText={header:'租金总结',month:'月',monthStart:'每月租期开始',monthEnd:'每月租期完结',dayMonth:'每月日数',rentFree:'免租日',dayPayable:'须付租金总日数',payableMonth:'须付租金总月数',Copr:'194 169 032 050 048 049 054 032 072 111 109 101 032 078 101 116 032 080 114 111 112 101 114 116 121 032 083 101 114 118 105 099 101 115 032 076 116 100 046 032 104 116 116 112 058 047 047 119 119 119 046 104 111 109 101 110 101 116 046 099 111 109 046 104 107 047',rentPerMonth:'每月需付租金'};
	var dText={averageRent: '<div class="result-desc">平均年租**</div>', stampDuty:'<div class="result-desc">= 印花税总数<br> (复本加5元)</div>',extraFee:'<div class="result-desc">(extra fee for a copy)</div>', payable: '', atRate: '<div class="result-desc">税率</div>'};
	var options={
		tableText:tText,
		dutyText:dText,
		rent:'#rent',
