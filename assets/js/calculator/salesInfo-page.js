...
$(document).ready(function(){
    ...
    var dText = { 
        avdscale2: '<a href="#avd-scale-2"><div class="result-desc">Stamp Duty</div><div class="result-desc2 small">(AVD Scale 2)</div></a>',
        avdscale1: '<a href="#avd-part-1"><div class="result-desc">Stamp Duty</div><div class="result-desc2 small">(Pt 1 of AVD Scale 1)</div></a>',
        ssd: '<a href="#bsd-table"><div class="result-desc">Buyer\'s Stamp Duty</div><div class="result-desc2">(BSD)</div></a>',
        ...
        bsd: '<a href="#ssd-table"><div class="result-desc">Special Stamp Duty</div><div class="result-desc2">(SSD)</div></a>'
        };
        var options={
            dutyText:dText,
            price:'#price',
