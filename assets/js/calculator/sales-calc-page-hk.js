...
$(document).ready(function(){
    ...
    var dText = { 
        avdscale2: '<a href="#avd-scale-2"><div class="result-desc">從價印花稅</div><div class="result-desc2 small">(AVD第2標準稅率)</div></a>',
        avdscale1: '<a href="#avd-part-1"><div class="result-desc">從價印花稅</div><div class="result-desc2 small">(AVD第1標準第1部稅率)</div></a>',
        ssd: '<a href="#bsd-table"><div class="result-desc">買家印花稅</div><div class="result-desc2">(BSD)</div></a>',
        ...
        bsd: '<a href="#ssd-table"><div class="result-desc">額外印花稅</div><div class="result-desc2">(SSD)</div></a>'
        };
        var options={
            dutyText:dText,
            price:'#price',
