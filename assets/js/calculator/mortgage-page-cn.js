...
$(document).ready(function() {
    ...
    dText = { type: 'Type', monthyPayments: '每月供款', interestColor: '#d4d0cc', mortgageColor: '#4f7a9f', cashColor: '#aaced4', cashOnly: 'Cash Only', totalCost: 'Total Cost Year End', loadBalance: 'Load Balance at year end', interestPaidMonth: '每月供款内之利息', annualInterestRate: '年利率', cash: 'Cash', amount: 'Amount)', interest: '利息总额', mortgage: '按揭总额', cash: '现金支出', total: '支付总额', year: '年', monthlyPayment: '每月供款', interestRate: '利率' };
    var options = {
        price: '#price',
