    ...
    $.fn.mortgage = function(options) {
    	var dText={type:'Type',monthyPayments:'每月供款',interestColor:'#d4d0cc',mortgageColor:'#4f7a9f',cashColor:'#aaced4',cashOnly:'现金支出',totalCost:'总支出',loadBalance:'余下供款',interestPaidMonth:'每月供款内之利息',annualInterestRate:'年利率',cash:'Cash',amount:'Amount)',interest:'利息总额',mortgage:'按揭总额',cash:'现金支出',total:'支付总额',year:'年',monthlyPayment:'每月供款',interestRate:'利率'};
    	...
    	var chartVisual=[ [dText.year, dText.monthyPayments, dText.interestRate], ['1', 1, 1]];
		...
		var chartoptions=
			...
			hAxis:{title: "Year", titleTextStyle:{fontSize: 11, italic: 'false', color: '#747474'},
			baselineColor: '#fff',
			gridlineColor: '#fff',
			gridlines:{count: 6},
			textStyle:{fontSize: 11, color: '#747474'}},
		...
		function calculate(){
			...
			bardata=google.visualization.arrayToDataTable([['Label', dText.amount],[dText.mortgage, mort_amount],[dText.cash, totalcash],[dText.interest, totalinterest]]);
			barformatter.format(bardata, 1);
			...
			monthly_payment.html('<tr><td>$'+averagepayment+'<br>平均每月供款</td></tr>');
			...
			tbl.append('<tr><th>支付总额</th><td>$'+totalcost+'</td></tr>');
			pietable.html(tbl);
			fadeBox.fadeIn(4000);
