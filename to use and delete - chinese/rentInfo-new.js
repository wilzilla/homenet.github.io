...
(function( $ ) {
    $.fn.rentInfo = function(options) {
		...
		function reset(){
			...
			dutyBox.html('---');
			atRateele.html('<span class="empty">Fill in the details below to start calculating</span>');
		...
		function creatTable(){
			...
			var tbl = $("<table></table>");
			totalRent=0;
			tbl.append('<tr class="header"><th class="m"><div class="head">'+tText.header+'</div></th><th class="dt"></th><th class="dt"></th><th class="dy"></th><th class="dy"></th><th class="dy"></th><th class="dy"></th><th class="tt"></th></tr><tr><th class="m">'+tText.month+'</th><th class="dt">'+tText.monthStart+'</th><th class="dt">'+tText.monthEnd+'</th><th class="dy">'+tText.dayMonth+'</th><th class="dy">'+tText.rentFree+'</th><th class="dy">'+tText.dayPayable+'</th><th class="dy">'+tText.payableMonth+'</th><th class="tt">'+tText.rentPerMonth+'</th></tr>');
